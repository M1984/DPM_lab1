...
public class BtmsControllerTest {
	...
	public void testCreateRouteSuccess() {
		...
		int numberBusStops = 5;
		
		try {
			BtmsController.createRoute(number, averageMinutes, numberBusStops);
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
		...
		// check model in memory
		checkResultRoute(number, averageMinutes, numberBusStops, btms, 1);
	}
	...
	public void testCreateRouteNotPositive() {
		...
		// check no change in memory
		checkResultRoute(number, averageMinutes, numberBusStops, btms, 0);
	}
	...
	@Test
	public void testCreateRouteAverageMinutesNotPositive() {
		BTMS btms = BtmsApplication.getBtms();		
		int number = 1;
		...
		// check error
		assertEquals("The average number of minutes to next bus stop must be greater than zero.", error);
		// check no change in memory
		checkResultRoute(number, averageMinutes, numberBusStops, btms, 0);
	}
	
	@Test
	public void testCreateRouteNumberBusStopsNotAtLeastTwo() {
		BTMS btms = BtmsApplication.getBtms();		
		int number = 1;
		int averageMinutes = 4;
		int numberBusStops = 1;
		...
		// check error
		assertEquals("The number of bus stops must be at least two.", error);
		// check no change in memory
		checkResultRoute(number, averageMinutes, numberBusStops, btms, 0);
	}
	...
	public void testDeleteRouteSuccess() {
		...
		try {
			BtmsController.deleteRoute(number);
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
	...
	@Test
	public void testDeleteRouteDoesNotExist() {
		BTMS btms = BtmsApplication.getBtms();
		int number = 1;
		int averageMinutes = 4;
		int numberBusStops = 5;
	...
	public void testUpdateRouteSuccess() {
		...
		int averageMinutes = 4;
		int numberBusStops = 5;
		int newAverageMinutes = 5;
		int newNumberBusStops = 4;
		...
		try {
			BtmsController.updateRoute(number, newAverageMinutes, newNumberBusStops);
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
		...
		// check model in memory
		checkResultRoute(number, newAverageMinutes, newNumberBusStops, btms, 1);
	}
	
	@Test
	public void testUpdateRouteDoesNotExist() {
		BTMS btms = BtmsApplication.getBtms();
		int number = 1;
		int averageMinutes = 4;
		int numberBusStops = 5;
		...
		String error = null;
		try {
			BtmsController.updateRoute(2, 5, 4);
		} catch (InvalidInputException e) {
			error = e.getMessage();
		}
		
		// check error
		assertEquals("A route with this number does not exist.", error);
		// check no change in memory
		checkResultRoute(number, averageMinutes, numberBusStops, btms, 1);
	}
	
	@Test
	public void testUpdateRouteAverageMinutesNotPositiveNumberBusStopsNotAtLeastTwo() {
		BTMS btms = BtmsApplication.getBtms();
		int number = 1;
		int averageMinutes = 4;
		int numberBusStops = 5;
		...
		String error = null;
		try {
			BtmsController.updateRoute(number, 0, 1);
		} catch (InvalidInputException e) {
			error = e.getMessage();
		}
		
		// check error
		assertEquals("The average number of minutes to next bus stop must be greater than zero. The number of bus stops must be at least two.", error);
		// check no change in memory
		checkResultRoute(number, averageMinutes, numberBusStops, btms, 1);
	}

	private void checkResultRoute(int number, int averageMinutes, int numberBusStops, BTMS btms, int numberRoutes) {
		assertEquals(numberRoutes, btms.getRoutes().size());
		if (numberRoutes > 0) {
			assertEquals(number, btms.getRoute(0).getNumber());
			assertEquals(averageMinutes, btms.getRoute(0).getAverageMinutesToNextBusStop());
			assertEquals(btms, btms.getRoute(0).getBTMS());
			assertEquals(0, btms.getRoute(0).getRouteAssignments().size());
			assertEquals(numberBusStops, btms.getRoute(0).getBusStops().size());
			int busStopNumber = 1;
	...
	public void testDeleteBusSuccess() {
		...
		try {
			BtmsController.deleteBus(licencePlate);
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
	...
	@Test
	public void testDeleteBusDoesNotExist() {
		BTMS btms = BtmsApplication.getBtms();
		String licencePlate = "XYZ123";
		...
		try {
			BtmsController.deleteBus("321ZYX");
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
	...
	public void testAssignBusSameDateDifferentRoute() {
		...
		int number2 = 2;
		int averageMinutes2 = 4;
		Route route2 = btms.addRoute(number2, averageMinutes2);
	...
	public void testDeleteAssignmentSuccess() {
		...
		try {
			BtmsController.deleteAssignment(licencePlate, number, date);
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
	...
	@Test
	public void testDeleteAssignmentLicencePlateDoesNotExist() {
		BTMS btms = BtmsApplication.getBtms();
		java.util.Date tempDate = btms.getCurrentDate();
		java.sql.Date date = new java.sql.Date(tempDate.getTime());
		String licencePlate = "XYZ123";
		...
		try {
			BtmsController.deleteAssignment("321ZYX", number, date);
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
	...
	@Test
	public void testDeleteAssignmentNumberDoesNotExist() {
		BTMS btms = BtmsApplication.getBtms();
		java.util.Date tempDate = btms.getCurrentDate();
		java.sql.Date date = new java.sql.Date(tempDate.getTime());
		String licencePlate = "XYZ123";
		...
		try {
			BtmsController.deleteAssignment(licencePlate, 0, date);
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
	...
	@Test
	public void testDeleteAssignmentDateDoesNotExist() {
		BTMS btms = BtmsApplication.getBtms();
		java.util.Date tempDate = btms.getCurrentDate();
		java.sql.Date date = new java.sql.Date(tempDate.getTime());
		String licencePlate = "XYZ123";
		...
		try {
			BtmsController.deleteAssignment(licencePlate, number, new java.sql.Date(tempDate.getTime() + 1000*60*60*24));
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
	...
	public void testDeleteScheduleSuccess() {
		...
		try {
			BtmsController.deleteSchedule(id, date, number, licencePlate, shift);
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
		...
		// check model in memory
		checkResultSchedule(driver, assignment, Shift.valueOf(shift), btms, 0, 1, 1, 1, 1);
	}
	
	@Test
	public void testDeleteScheduleDriverDoesNotExist() {
		BTMS btms = BtmsApplication.getBtms();
		java.util.Date tempDate = btms.getCurrentDate();
		java.sql.Date date = new java.sql.Date(tempDate.getTime());
		String licencePlate = "XYZ123";
		...
		try {
			BtmsController.deleteSchedule(nextDriverID, date, number, licencePlate, shift);
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
	...
	@Test
	public void testDeleteScheduleAssignmentDateNull() {
		BTMS btms = BtmsApplication.getBtms();
		java.util.Date tempDate = btms.getCurrentDate();
		java.sql.Date date = new java.sql.Date(tempDate.getTime());
		String licencePlate = "XYZ123";
		...
		try {
			BtmsController.deleteSchedule(id, null, number, licencePlate, shift);
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
	...
	@Test
	public void testDeleteScheduleAssignmentNumberDoesNotExist() {
		BTMS btms = BtmsApplication.getBtms();
		java.util.Date tempDate = btms.getCurrentDate();
		java.sql.Date date = new java.sql.Date(tempDate.getTime());
		String licencePlate = "XYZ123";
		...
		try {
			BtmsController.deleteSchedule(id, date, 0, licencePlate, shift);
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
	...
	@Test
	public void testDeleteScheduleAssignmentLicencePlateNull() {
		BTMS btms = BtmsApplication.getBtms();
		java.util.Date tempDate = btms.getCurrentDate();
		java.sql.Date date = new java.sql.Date(tempDate.getTime());
		String licencePlate = "XYZ123";
		...
		try {
			BtmsController.deleteSchedule(id, date, number, null, shift);
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
	...
	@Test
	public void testDeleteScheduleAssignmentLicencePlateDoesNotExist() {
		BTMS btms = BtmsApplication.getBtms();
		java.util.Date tempDate = btms.getCurrentDate();
		java.sql.Date date = new java.sql.Date(tempDate.getTime());
		String licencePlate = "XYZ123";
		...
		try {
			BtmsController.deleteSchedule(id, date, number, "321ZYX", shift);
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
	...
	@Test
	public void testDeleteScheduleShiftNull() {
		BTMS btms = BtmsApplication.getBtms();
		java.util.Date tempDate = btms.getCurrentDate();
		java.sql.Date date = new java.sql.Date(tempDate.getTime());
		String licencePlate = "XYZ123";
		...
		try {
			BtmsController.deleteSchedule(id, date, number, licencePlate, null);
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
	...
	@Test
	public void testDeleteScheduleShiftDoesNotExist() {
		BTMS btms = BtmsApplication.getBtms();
		java.util.Date tempDate = btms.getCurrentDate();
		java.sql.Date date = new java.sql.Date(tempDate.getTime());
		String licencePlate = "XYZ123";
		...
		try {
			BtmsController.deleteSchedule(id, date, number, licencePlate, "Night");
		} catch (InvalidInputException e) {
			// check that no error occurred
			fail();
		}
