...
public class BTMS implements Serializable
{
  ...
  /* Code from template association_AddManyToOne */
  public Route addRoute(int aNumber, int aAverageMinutesToNextBusStop)
  {
    return new Route(aNumber, aAverageMinutesToNextBusStop, this);
  }
