...
public class Discovery
{
  ...
  public Discovery(Comment... allComments)
  {
    ...
    if (!didAddComments)
    {
      throw new RuntimeException("Unable to create Discovery, must have 2 to 4 comments");
    }
  }
  ...
  public boolean setComments(Comment... newComments)
  {
    ...
    if (verifiedComments.size() != newComments.length || verifiedComments.size() < minimumNumberOfComments() || verifiedComments.size() > maximumNumberOfComments())
    {
      return wasSet;
    }
